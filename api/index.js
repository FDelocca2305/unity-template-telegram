...
const webURL = "unity-template-telegram.vercel.app";
...
server.use(express.static(path.join(__dirname, "../public"))); // Ajusta la ruta al moverlo a /api
...
// Exporta la aplicación como serverless
